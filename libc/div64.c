...
uint64_t 
__ashldi3(uint64_t num, unsigned int shift)
{
...
uint64_t 
__lshrdi3(uint64_t num, unsigned int shift)
{
	union overlay64 output;
...
static uint64_t 
_64bit_divide(uint64_t dividend, uint64_t divider, uint64_t *rem_p)
{
	uint64_t result = 0;
